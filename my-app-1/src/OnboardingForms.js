...
class OnboardingForms extends Component {
    constructor(props) {
        ...
        this.renderAccountBalances = this.renderccountBalances.bind(this)
    ...
    render() {
        if (this.state.stage === 'income') {
            const form = <ComposeForm 
                fields={[
                    {fieldTitle: 'First Name', fieldName: 'firstName'},
            ...
            const form = <p> Onboarding form didnt work, state is {this.state.stage} </p>
        return form
